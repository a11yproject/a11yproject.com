...
The funds go towards keeping the site running, as well as being able to pay new authors for their work! Being able to compensate people writing solid, approachable advice has been a longtime goal that we are delighted to have achieved. 

### Tatiana Mac

We also were fortunate enough to be able to hire [Tatiana Mac](https://tatianamac.com/). If you are unfamiliar with Tatiana’s work, she is an incredible designer, speaker, and accessibility and inclusion advocate. 

The redesign makes The A11Y Project a living testament to the idea that accessible experiences are beautiful ones. [Tatiana’s unique voice](https://tatianamac.com/writing) brought a dramatic, unapologetically bold look to our website. Her design choices deliberately interwove into our existing content and structure, allowing us to enhance the experience without sacrificing accessibility.
...
Our design and development choices are deliberate—accessibility should permeate all aspects of a digital experience. Because of this, we have adopted [Eleventy](https://www.11ty.dev/), a simple, yet powerful static site generator created by [Zach Leatherman](https://www.zachleat.com/).

Eleventy is built with performance in mind. This allows The Accessibility Project to be fast. This includes being able to reliably function on an incredibly wide range of devices, but also the ease for a volunteer to get started with contributing to the website. 
...
Accessibility is oftentimes seen as something you do after the fact. Through the practice of Inclusive Design, we are hoping to expand on our content and help shift the conversation of accessibility so it is a first and foremost consideration during all phases of digital work.
...
We have a [Code of Conduct](/code-of-conduct/) that is shaped from our project values. The presence of a Code of Conduct helps to foster a safe and welcoming environment to enable a harassment-free experience for everyone.
...
We acknowledge this redesign occurred during a global pandemic. We hope that this redesign is seen as an example of international, cross-discipline collaboration.
