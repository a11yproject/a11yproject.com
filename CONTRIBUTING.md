...
1. [About this site](#about-this-site)
    ...
    1. [Important Branches](#important-branches)
    1. [Editing Files](#editing-files)
1. [Submitting content](#submitting-content)
    1. [Content Style Guide](#content-style-guide)
    1. [Articles](#articles)
    1. [Events](#events)
    1. [Patterns](#patterns)
    1. [Resources](#resources)
    1. [Rejection](#resources)
1. [Fixing things](#fixing-things)
    1. [Reporting Issues](#reporting-issues)
    1. [Submitting Pull Requests](#submitting-pull-requests)
    1. [Stale Issues and Pull Requests](#stale-issues-and-pull-requests)
    1. [Labels](#labels)
1. [License](#license)
